    ...
    return (
      <Html lang="en">
        <Head>
          ...
          />
          <link rel="apple-touch-icon" sizes="180x180" href="/img/favicons/kcLogoMini.png" />
          <link rel="icon" type="image/png" sizes="32x32" href="/img/favicons/kcLogoMini.png" />
          <link rel="icon" type="image/png" sizes="16x16" href="/img/favicons/kcLogoMini.png" />
          <link rel="manifest" href="/img/favicons/site.webmanifest" />
          <link rel="mask-icon" href="/img/favicons/kcLogoMini.png" color="#5bbad5" />
